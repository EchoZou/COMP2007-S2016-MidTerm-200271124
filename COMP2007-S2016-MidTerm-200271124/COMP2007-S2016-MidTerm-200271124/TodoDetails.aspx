<%@ Page Title="Todo Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TodoDetails.aspx.cs" Inherits="COMP2007_S2016_MidTerm_200271124.TodoDetails" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="form-group">
                    <asp:CheckBox runat="server" ID="CompletedCheckBox"></asp:CheckBox>
